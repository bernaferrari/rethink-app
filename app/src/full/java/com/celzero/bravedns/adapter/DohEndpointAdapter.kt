        ...
        when (state) {
            is DoHDialogState.Delete -> {
                AlertDialog(
                    ...
                    title = { Text(text = context.resources.getString(R.string.doh_custom_url_remove_dialog_title)) },
                    text = { Text(text = context.resources.getString(R.string.doh_custom_url_remove_dialog_message)) },
                    confirmButton = {
                        TextButton(
                            onClick = {
...
private fun updateConnection(scope: CoroutineScope, endpoint: DoHEndpoint, appConfig: AppConfig) {
