...
class VpnControlReceiver: BroadcastReceiver(), KoinComponent {
    ...
    companion object {
        ...
        private const val ACTION_START = "com.bernaferrari.bravedns.intent.action.VPN_START"
        private const val ACTION_STOP = "com.bernaferrari.bravedns.intent.action.VPN_STOP"
