...
class BubbleDismissReceiver : BroadcastReceiver(), KoinComponent {
    ...
    companion object {
        const val ACTION_BUBBLE_DISMISSED = "com.bernaferrari.bravedns.action.BUBBLE_DISMISSED"
        const val ACTION_BUBBLE_DISABLE = "com.bernaferrari.bravedns.action.BUBBLE_DISABLE"
    }
