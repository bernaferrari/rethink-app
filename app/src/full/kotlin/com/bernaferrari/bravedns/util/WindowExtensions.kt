...
fun ComponentActivity.handleFrostEffectIfNeeded(themeId: Int) {
    ...
    val windowBackgroundDrawable: Drawable? =
        ContextCompat.getDrawable(this, R.drawable.window_background)
...
private fun ComponentActivity.setupWindowBlurListener(windowBackgroundDrawable: Drawable?) {
...
private fun ComponentActivity.updateWindowForBlurs(
...
fun ComponentActivity.disableFrostTemporarily() {
...
fun ComponentActivity.restoreFrost(themeId: Int) {
