...
class FirewallManagerTest : KoinTest {
    ...
    private fun clearFirewallManagerState() {
        try {
            ...
            val globalVariableClass = Class.forName("com.bernaferrari.bravedns.service.FirewallManager\$GlobalVariable")
            val appInfosField = globalVariableClass.getDeclaredField("appInfos")
            appInfosField.isAccessible = true
            @Suppress("UNCHECKED_CAST")
            val appInfos = appInfosField.get(null) as com.bernaferrari.bravedns.util.UidMultimap<AppInfo>
            appInfos.clear()
