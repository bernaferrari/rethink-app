...
class FirewallRulesetTest {
    ...
    fun testRuleActions() {
        ...
        assertEquals(com.bernaferrari.bravedns.R.integer.block, FirewallRuleset.RULE1B.act)
        
        // RULE8 should be an allow rule
        assertEquals(com.bernaferrari.bravedns.R.integer.allow, FirewallRuleset.RULE8.act)
