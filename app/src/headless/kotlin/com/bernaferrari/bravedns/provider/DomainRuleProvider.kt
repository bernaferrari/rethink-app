...
import com.bernaferrari.bravedns.database.CustomDomainRepository
...
class DomainRuleProvider : ContentProvider() {
    ...
    companion object {
        private const val AUTHORITY = "com.bernaferrari.bravedns.domainrulesprovider"
    ...
    override fun query(
        ...
        return runBlocking { customDomainRepository.getRulesCursor() }
    }
