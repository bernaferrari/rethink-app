 ...
 */
package com.bernaferrari.bravedns.provider
...
import com.bernaferrari.bravedns.database.getAllFileTagsCursor
import com.bernaferrari.bravedns.database.getFileTagByIdCursor
import com.bernaferrari.bravedns.database.getFileTagsCursor
import com.bernaferrari.bravedns.database.getSelectedFileTagsCursor
...
class BlocklistProvider : ContentProvider() {
    ...
    companion object {
        private const val AUTHORITY = "com.bernaferrari.bravedns.blocklistprovider"
            ...
            cursor =
                runBlocking {
                    when (it) {
                        ...
                        1 -> localFileTagRepository.getFileTagsCursor()
                        2 -> localFileTagRepository.getSelectedFileTagsCursor()
                        3 -> localFileTagRepository.getAllFileTagsCursor()
                        4 ->
                            localFileTagRepository.getFileTagByIdCursor(
