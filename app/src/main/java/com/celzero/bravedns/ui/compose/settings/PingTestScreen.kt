...
fun PingTestScreen(
    ...
    suspend fun isReachable(csv: String): Boolean {
        ...
        Logger.d(TAG, "$TAG ip $csv reachable: $reachable")
        return reachable
    }
    ...
    suspend fun calculateStrength(csv: String): Int {
        ...
        Logger.i(TAG, "$TAG strength: $strengthVal ($status)")
        return strengthVal
    }
    ...
    fun performPing() {
        scope.launch {
            try {
                ...
                Logger.v(TAG, "$TAG initiating ping test")
                ...
                Logger.e(TAG, "err isReachable: ${e.message}", e)
