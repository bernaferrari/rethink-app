    ...
    LaunchedEffect(configId) {
        withContext(Dispatchers.IO) {
            ...
            withContext(Dispatchers.Main) {
                ...
                var dns = iface?.dnsServers?.joinToString { it }
                ...
                listenPort = if (showListenPortState) {
                    iface?.listenPort?.toString().orEmpty()
                } else {
                    ""
                }
    ...
    fun saveConfig() {
        ...
        scope.launch(Dispatchers.IO) {
            try {
                ...
                Logger.e(Logger.LOG_TAG_UI, "err while parsing wg interface: $error", e as? Exception)
                withContext(Dispatchers.Main) {
