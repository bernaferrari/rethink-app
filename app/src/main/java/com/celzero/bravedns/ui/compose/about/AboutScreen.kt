                    ...
                    AboutSection(
                        ...
                        items = listOf(
                            AboutItem(
                                ...
                                iconPainter = rememberVectorPainter(image = Icons.Filled.Public),
                            ...
                            AboutItem(
                                ...
                                iconPainter = rememberVectorPainter(image = Icons.AutoMirrored.Filled.HelpOutline),
                                onClick = onFaqClick
                            ),
                            AboutItem(
                                headline = stringResource(id = R.string.about_docs),
                                iconPainter = rememberVectorPainter(image = Icons.AutoMirrored.Filled.Article),
                                onClick = onDocsClick
                            ),
                            AboutItem(
                                stringResource(id = R.string.about_privacy_policy),
                                rememberVectorPainter(image = Icons.Filled.Policy),
                                onPrivacyPolicyClick
                            ),
                            AboutItem(
                                stringResource(id = R.string.about_terms_of_service),
                                rememberVectorPainter(image = Icons.Filled.Gavel),
                                onTermsOfServiceClick
                            ),
                            AboutItem(
                                stringResource(id = R.string.about_license),
                                rememberVectorPainter(image = Icons.AutoMirrored.Filled.Article),
                                onLicenseClick
                            ),
                        ),
                    )
                    ...
                    AboutSection(
                        ...
                        items = listOf(
                            ...
                            AboutItem(
                                ...
                                rememberVectorPainter(image = Icons.Filled.VpnKey),
                                onVpnProfileClick
                            ),
                            AboutItem(
                                stringResource(id = R.string.about_settings_notification),
                                rememberVectorPainter(image = Icons.Filled.Notifications),
                                onNotificationClick
                            ),
                        ),
                    )
                ...
                val items = buildList {
                    ...
                    add(
                        AboutItem(
                            ...
                            rememberVectorPainter(image = Icons.Filled.Backup),
                            onDbStatsClick
                        )
                    )
                    if (uiState.isDebug) {
    ...
    val listItems = buildList {
        add(
            AboutItem(
                ...
                iconPainter = rememberVectorPainter(image = Icons.Filled.NewReleases),
