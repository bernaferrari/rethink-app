...
import com.bernaferrari.bravedns.net.doh.CountryMap
import com.bernaferrari.bravedns.service.BraveVPNService
import com.bernaferrari.bravedns.service.DnsLogTracker
import com.bernaferrari.bravedns.storage.appFileSystem
import com.bernaferrari.bravedns.util.Constants.Companion.FLAVOR_FDROID
import com.bernaferrari.bravedns.util.Constants.Companion.FLAVOR_HEADLESS
import com.bernaferrari.bravedns.util.Constants.Companion.FLAVOR_PLAY
import com.bernaferrari.bravedns.util.Constants.Companion.FLAVOR_WEBSITE
...
import com.bernaferrari.bravedns.util.Constants.Companion.MISSING_UID
...
import com.bernaferrari.firestack.backend.Gobyte
import com.bernaferrari.firestack.backend.Gostr

import com.bernaferrari.bravedns.util.JsonHelper.getString
import com.bernaferrari.bravedns.util.JsonHelper.parseObject
...
object Utilities {
    ...
    fun getETldPlus1(fqdn: String): String? {
        val normalized = fqdn.trim().trimEnd('.')
        if (normalized.isEmpty()) return fqdn
    ...
    fun getDefaultIcon(context: Context): Drawable? {
        return ContextCompat.getDrawable(context, R.drawable.default_app_icon)
    }
    ...
    fun getTagValueFromJson(path: String, tag: String): String {
        ...
        try {
            ...
            val value = getString(jsonObject, tag)
            if (value != null) {
                tagValue = value
