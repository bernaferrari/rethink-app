...
import com.bernaferrari.bravedns.database.ProxyEndpoint.Companion.DEFAULT_PROXY_TYPE
...
import com.bernaferrari.bravedns.util.Constants.Companion.HTTP_PROXY_PORT
import com.bernaferrari.bravedns.util.Constants.Companion.SOCKS_DEFAULT_PORT
import com.bernaferrari.bravedns.util.Utilities.getActivityPendingIntent
import com.bernaferrari.bravedns.util.Utilities.getBroadcastPendingIntent
import com.bernaferrari.bravedns.util.Utilities.isAtleastO
import com.bernaferrari.bravedns.util.Utilities.isAtleastT
...
import com.bernaferrari.bravedns.util.Utilities.isValidPort
...
class OrbotHelper(
    ...
    companion object {
        ...
        // https://github.com/guardianproject/orbot/blob/master/orbotservice/src/main/kotlin/org/torproject/android/service/TorServiceConstants.java
    ...
    fun stopOrbot(isInteractive: Boolean) {
        ...
        persistentState.orbotConnectionStatus.value = false
