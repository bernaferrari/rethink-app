...
import com.bernaferrari.bravedns.viewmodel.SubscriptionUiState
import com.bernaferrari.bravedns.util.Utilities.togb
...
import com.bernaferrari.firestack.backend.asGostr
import com.bernaferrari.firestack.backend.s
...
object PipKeyManager : KoinComponent {
    ...
    private suspend fun publicKeyUsable(context: Context, retryCount: Int = 0, shouldPersistResult: Boolean): Pair<Boolean, String> {
        ...
        try {
            ...
            Logger.v(LOG_TAG_PROXY, "$TAG publicKeyUsable: response body: $responseBody")
            // parse the response body to ApiResponse
            val apiResponse = JsonHelper.json.decodeFromJsonElement(ApiResponse.serializer(), responseBody)
