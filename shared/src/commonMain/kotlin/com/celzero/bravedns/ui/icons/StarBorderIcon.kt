...
internal val filledStarBorder: ImageVector
  get() {
    if (_filledStarBorder != null) {
      return _filledStarBorder!!
    }
    _filledStarBorder =
      ImageVector.Builder(
          name = "star_border",
...
internal var _filledStarBorder: ImageVector? = null

@Suppress("CheckReturnValue")
internal val outlinedStarBorder: ImageVector
  get() {
    if (_outlinedStarBorder != null) {
      return _outlinedStarBorder!!
    }
    _outlinedStarBorder =
      ImageVector.Builder(
          name = "star_border",
...
internal var _outlinedStarBorder: ImageVector? = null
