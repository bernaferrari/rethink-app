...
class RethinkLocalFileTagRepository(private val rethinkLocalFileTagDao: RethinkLocalFileTagDao) {
    ...
    suspend fun updateAll(fileTags: List<RethinkLocalFileTag>) {
    ...
    suspend fun contentGetFileTags(): List<RethinkLocalFileTag> {
        return rethinkLocalFileTagDao.getFileTags()
    }

    suspend fun contentGetSelectedFileTags(): List<RethinkLocalFileTag> {
        return rethinkLocalFileTagDao.getFileTags()
    }

    suspend fun contentGetAllFileTags(): List<RethinkLocalFileTag> {
        return rethinkLocalFileTagDao.getFileTags()
    }

    suspend fun contentGetFileTagById(id: Int): List<RethinkLocalFileTag> {
        return rethinkLocalFileTagDao.getFileTags()
    }
}
