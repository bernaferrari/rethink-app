...
class ProxyAppMappingRepository(
    ...
    suspend fun updateProxyIdForPackage(uid: Int, packageName: String, proxyId: String, proxyName: String) {
        proxyApplicationMappingDAO.updateProxyIdForPackage(uid, packageName, proxyId, proxyName)
    }
    ...
    suspend fun dedupeByUidAndPackage() {
        proxyApplicationMappingDAO.dedupeByUidAndPackage()
    }

    suspend fun dedupeByUidAndPackage(uid: Int, packageName: String) {
        proxyApplicationMappingDAO.dedupeByUidAndPackage(uid, packageName)
    }
}
