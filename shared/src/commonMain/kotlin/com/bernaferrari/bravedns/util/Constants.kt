...
class Constants {
    ...
    companion object {
        ...
        val ONDEVICE_BLOCKLIST_DOWNLOAD_PATH = "/" + "downloads" + "/"
        ...
        val ONDEVICE_BLOCKLIST_FILE_TAG = "/" + FILE_TAG
        ...
        val ONDEVICE_GEOIP_IPV4 = "/" + "dbip.v4"
        val ONDEVICE_GEOIP_IPV6 = "/" + "dbip.v6"
        ...
        const val RETHINK_PACKAGE = "com.bernaferrari.bravedns"
        ...
        // constants generated as part of com.bernaferrari.bravedns.BuildConfig.FLAVORS
        ...
        const val NOTIF_ACTION_DB_CORRUPTED_CLEAR = "DB_CORRUPTED_CLEAR"
        const val NOTIF_ACTION_DB_CORRUPTED_DISMISS = "DB_CORRUPTED_DISMISS"
        const val NOTIF_ACTION_RETHINK_BLOCK_DISMISS = "RETHINK_BLOCK_DISMISS"
        ...
        const val NOTIF_INTENT_EXTRA_IAB_DEVICE_NOT_REGISTERED_NAME =
            "IAB_DEVICE_NOT_REGISTERED"
        const val NOTIF_INTENT_EXTRA_IAB_DEVICE_NOT_REGISTERED_VALUE =
            "IAB_DEVICE_NOT_REGISTERED_NOTIFY"
        ...
        // Ref: {@link com.bernaferrari.bravedns.util.Utilities#isAccessibilityServiceEnabled} and
        // {@link
        // com.bernaferrari.bravedns.util.Utilities#isAccessibilityServiceEnabledViaSettingsSecure}
        const val ACCESSIBILITY_SERVICE_HEARTBEAT_THRESHOLD_MS = 5L * 60L * 1000L

        // minimum interval before checking if there is a change in active network
        // (metered/unmetered)
        const val ACTIVE_NETWORK_CHECK_THRESHOLD_MS = 60L * 1000L
        ...
        const val LIVEDATA_PAGE_SIZE = PAGING_PAGE_SIZE
