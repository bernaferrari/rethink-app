...
class ConnectionTrackerRepository(private val connectionTrackerDAO: ConnectionTrackerDAO) {
    ...
    fun observeBlockedConnectionsCount(): Flow<Int> {
        val since = com.bernaferrari.bravedns.platform.currentTimeMillis() - BLOCKED_WINDOW_MS

        return connectionTrackerDAO.observeBlockedConnectionsCount(since)
    }
}
