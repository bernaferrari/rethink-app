...
interface AppInfoDAO {
    ...
    @Query("update AppInfo set isProxyExcluded = :bypass where packageName = 'com.bernaferrari.bravedns'")
    suspend fun setRethinkToBypassProxy(bypass: Boolean)

    @Query("update AppInfo set firewallStatus = 7, connectionStatus = 3 where packageName = 'com.bernaferrari.bravedns'")
