...
internal val filledEditLocationAlt: ImageVector
  get() {
    if (_filledEditLocationAlt != null) {
      return _filledEditLocationAlt!!
    }
    _filledEditLocationAlt =
      ImageVector.Builder(
        ...
        .apply {
          path(
            ...
            quadToRelative(0.2f, 0f, 0.38f, 0f)
            reflectiveQuadToRelative(0.35f, 0.02f)
            quadToRelative(0.63f, 0.05f, 0.82f, 0.66f)
            reflectiveQuadTo(13.25f, 3.8f)
            lineTo(9.58f, 7.5f)
            quadTo(9.3f, 7.77f, 9.15f, 8.14f)
            reflectiveQuadTo(9f, 8.9f)
            verticalLineTo(11f)
            quadToRelative(0f, 0.82f, 0.59f, 1.41f)
            reflectiveQuadTo(11f, 13f)
            horizontalLineToRelative(2.1f)
            quadToRelative(0.4f, 0f, 0.76f, -0.15f)
            reflectiveQuadTo(14.5f, 12.43f)
            lineTo(18.18f, 8.75f)
            quadTo(18.65f, 8.27f, 19.25f, 8.48f)
            quadToRelative(0.6f, 0.2f, 0.7f, 0.82f)
            quadToRelative(0.02f, 0.22f, 0.04f, 0.45f)
...
internal var _filledEditLocationAlt: ImageVector? = null
